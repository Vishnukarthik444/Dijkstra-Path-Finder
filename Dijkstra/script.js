...
const graph = [
  [0,  2,  5,  6,  10, 14, 16, 19, 20, 25],   // hubli
  [2,  0,  3,  4,  8,  12, 14, 17, 18, 23],   // hdmc
  [5,  3,  0,  1,  5,  9,  11, 13, 15, 20],   // kims
  [6,  4,  1,  0,  4,  8,  10, 13, 14, 19],   // unkal 
  [10, 8,  5,  4,  0,  4,  6,  9,  10, 15],   // navanagar
  [14, 12, 9,  8,  4,  0,  2,  5,  6,  11],   // medical
  [16, 14, 11, 10, 6,  2,  0,  3,  4,  9],    // sattur
  [19, 17, 13, 13, 9,  5,  3,  0,  1,  6],    // gandhinagar
  [20, 18, 15, 14, 10, 6,  4,  1,  0,  5],    // toll naka
  [25, 23, 20, 19, 15, 11, 9,  6,  5,  0]     // dharwad
];
